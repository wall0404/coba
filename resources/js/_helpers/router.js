...
import Page_RemoteWorkDateTimeSelection from "../components/Pages/Book/Page_RemoteWorkDateTimeSelection";
...
const routes = [
    ...
    { path: '/booking/new/remotework', name: "RemoteWorkDateTimeSelection", props: true, component: Page_RemoteWorkDateTimeSelection, meta:{auth:true} },
